...
description: Drupal security expertise — auto-activates when writing forms, controllers, queries, or handling user input to prevent XSS, SQL injection, and access bypass vulnerabilities
---
...
// NOT:
$this->logger->info('Login: ' . $username . ':' . $password);
