---
name: plan-protocol
description: Guidelines for creating and managing implementation plans with citations — use when starting a multi-step implementation or tracking progress across phases
...
1. You delegate research to a researcher or explorer
